...
<a href="<?php echo site_url();?>Company/addCompany" class="btn btn-success" style="float:right;margin-bottom:10px;">Add Company</a>
<table class="table table-striped table-bordered" id="company_table">
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo $s;?></td>
            <td><img width="30" height="30" src="<?php echo base_url();?>uploads/<?php echo $val['logo'];?>"/></td>
